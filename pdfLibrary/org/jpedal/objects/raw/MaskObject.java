...
public class MaskObject extends XObject
{
  ...
  public MaskObject(String paramString)
  {
    super(paramString);
    this.objType = 489767739;
  }

  public MaskObject(int paramInt1, int paramInt2)
  {
 ...
 * Qualified Name:     org.jpedal.objects.raw.MaskObject
